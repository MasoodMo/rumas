...
<head>
	<title>Musical World | Telugu Songs</title>
	...
	<header>
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-light">
                ...
                <li class="nav-item">
                    ...
                    <p style="color:blue;">| Telugu Songs |</p>
                </li>
      ...
      aria-haspopup="true" aria-expanded="false">Track</button>
								<div class="dropdown-menu dropdown-primary">
									<a class="dropdown-item" href="telugu_songs.php"><b>Telugu Songs</b></a>
		...
		<?php
			...
			if(mysqli_num_rows($result)>0){
				while($row = mysqli_fetch_array($result)){
					...
					echo "
							<div class='col-md-3'>
								<form method='post' action='telugu_songs.php'>
									<div class='card-deck'>
										<div class='card-img'>
											<img src='songs/telugu_songs/img/$song_image' style='width:350px;height:250px;'alt=''>
										</div>
										<div class='card-desc'>
											<h3>$song_name | $singer_name</h3>
											<h3>movie - $movie_name</h3>
											<audio class='embed-responsive-item' controls='' preload='none'> <source src='songs/telugu_songs/$audio_file' type='audio/mp3'></audio><br>
				...
				<div class="col-lg-6 contact-bottom d-flex flex-column contact-right-w3ls">
					...
					<div class="fv3-contact">
						<div class="row">
							...
							<div class="col-10">
								<h6>Email</h6>
								<p>
									<a href="mailto:example@email.com" class="text-dark">devmasca@gmail.com</a>
								</p>
							</div>
						</div>
					</div>
					...
					<div class="fv3-contact">
						<div class="row">
							...
							<div class="col-10">
								<h6>Address</h6>
								<p>Sharda University | Greater Noida Uttar Pradesh</p>
							</div>
						</div>
					</div>
				</div>
